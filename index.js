            ...
            if(response.RespCode == 200) {
                ...
                for (let i = 0; i < product.length; i++) {
                    html += `<div onclick="openProductDetail(${i})" class="product-items ${product[i].type}">
                                <img class="product-img" src="./uploads/imgs/${product[i].img}" alt="">
                            </div>`;
                }
...
function searchsomething(elem) {
    ...
    if(html == '') {
        $("#productlist").html(`<p>Not found Artwork</p>`);
    } else {
        $("#productlist").html(html);
    }
...
function openProductDetail(index) {
    ...
    $('#btndownload').attr('href', './uploads/zip/'+product[index].filezip)
    $("#modalDesc").css('display', 'flex')
    $("#mdd-img").attr('src', './uploads/imgs/' + product[index].img);
        ...
        for (let i = 0; i < cart.length; i++) {
            html += `<div class="cartlist-items">
                        <div class="cartlist-left">
                            <img src="./uploads/imgs/${cart[i].img}" alt="">
